...
console.log('Exercise 5 Result:', greetUser("Bob", "night"));
*/
...
console.log('Exercise 6 Result:', maxOfThree(15, 18, 21));
console.log('Exercise 6 Result:', maxOfThree(23, 17, 13));
*/
...
console.log('Exercise 7 Result:', calculateTip(80, 35));
...
console.log('Exercise 8 Result:', convertTemperature(12, "C"));
console.log('Exercise 8 Result:', convertTemperature(80, "F"));
 */
...
const createUsername = (firstName,lastName) => {
    ...
    let totalLen = firstName.length + lastName.length;
    return output += totalLen;
}

console.log('Exercise 11 Result:', createUsername("Samantha", "Green"));
console.log('Exercise 11 Result:', createUsername("Mark", "Spencer"));
 */
